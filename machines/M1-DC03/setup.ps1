# M1-DC03 Setup Script — Operation HOLLOW CROWN
# Run as Administrator on the target machine

Write-Host "[*] Starting M1-DC03 configuration..." -ForegroundColor Cyan
...
Write-Host "[+] M1-DC03 base configuration complete" -ForegroundColor Green
