# M3-SRV09-SQL Setup Script — Operation HOLLOW CROWN
# Run as Administrator on the target machine

Write-Host "[*] Starting M3-SRV09-SQL configuration..." -ForegroundColor Cyan
...
Write-Host "[+] M3-SRV09-SQL base configuration complete" -ForegroundColor Green
